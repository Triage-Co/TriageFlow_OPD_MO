...
export default function InterviewScreen() {
  ...
  const { currentQuestion, isLoading, error, answerQuestion, clearSession } = useTriage();
      ...
      <ScreenWrapper>
        <View className="flex-1 items-center justify-center p-5 bg-[#F8FAFC]">
          <Text className="text-gray-500 text-center text-[14px] font-medium mb-4">
            Không tìm thấy câu hỏi chẩn đoán hiện tại hoặc phiên hỏi bệnh đã kết thúc.
          </Text>
  ...
  return (
    <ScreenWrapper edges={["left", "right"]}>
      ...
      <View className="flex-1 justify-between bg-[#F8FAFC]">
        {/* ── 1. HEADER (Đồng bộ style với body-map và symptoms) ── */}
        <View className="bg-primary px-5 pt-12 pb-5 shadow-sm">
          <View className="flex-row items-center justify-between mb-4">
            ...
            <Pressable
              onPress={handleQuit}
              className="bg-white/20 px-3 py-1.5 rounded-full active:opacity-75"
            >
              <Text className="text-white text-[11px] font-bold">Hủy bỏ</Text>
            </Pressable>
          </View>

          {/* Thanh Tiến trình (Bước 3/3) */}
          <View className="mt-1">
        ...
        <View className="flex-1 px-5 pt-5">
          ...
          {/* Danh sách items cần trả lời của câu hỏi */}
          <ScrollView
            className="flex-1"
                  ...
                  >
                    ...
                    <View className="flex-row gap-2">
                      {[
                        ...
                        let btnStyle = "bg-[#F8FAFC] border-gray-200";
                        ...
                        if (isChosen) {
                          if (choice.id === "present") {
                            ...
                            btnStyle = "bg-red-50 border-red-200";
                            textStyle = "text-red-700 font-bold";
                          } else {
                            btnStyle = "bg-gray-100 border-gray-300";
                        ...
                        return (
                          <Pressable
                            ...
                            className={`flex-1 py-3 rounded-[12px] border items-center justify-center active:opacity-85 ${btnStyle}`}
                          >
